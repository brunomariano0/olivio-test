            ...
            <div>
              ...
              <div className="space-y-6 mt-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">R. Ana Ramos da Silva, 000 - Machado <br></br>
                     Araçoiaba da Serra - SP, 18190-000</p>                    
                  </div>
                </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  ...
                  <a 
                    href="https://api.whatsapp.com/send/?phone=5511994424033&text=Ol%C3%A1%2C+tudo+bem%3F+Gostaria+de+saber+mais+sobre+os+filhotes+do+Canil+Von+Olivio%21&type=phone_number&app_absent=0" 
                    className="bg-gray-100 w-12 h-12 rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-colors"
                    aria-label="WhatsApp"
                  >
